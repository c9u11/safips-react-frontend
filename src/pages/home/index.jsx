...
export default function Home() {
  const { driveHistory, accelerationX, accelerationY, accelerationZ, gyroscopeX, gyroscopeY, gyroscopeZ, setAccelerationData, setGyroscopeData, startDrive, stopDrive } = useDriveStore();
  ...
  return (
    <div className='py-3 px-10 gap-2 flex flex-col'>
      <div className='flex gap-2'>
        ...
        <button className='bg-blue-500 text-white p-2 rounded-md' onClick={startHandler}>Start</button>
        <button className='bg-blue-500 text-white p-2 rounded-md' onClick={endHandler}>Stop</button>
      </div>
